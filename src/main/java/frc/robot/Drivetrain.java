...
public class Drivetrain {
  ...
  private final AbsoluteEncoder m_leftAbsoluteEncoder = m_leftFollower.getAbsoluteEncoder();
  private final AbsoluteEncoder m_rightAbsoluteEncoder = m_rightFollower.getAbsoluteEncoder();
